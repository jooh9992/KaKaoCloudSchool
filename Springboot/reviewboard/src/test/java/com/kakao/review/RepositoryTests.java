...
import com.kakao.review.persistence.MemberRepositoty;
...
public class RepositoryTests {
    ...
    public void joinTest(){
        Pageable pageable = PageRequest.of(
                0, 10, Sort.by(Sort.Direction.DESC,
                        "mno"));
    ...
    public void getReviews(){
        Movie movie = Movie.builder().mno(76L).build();
    ...
    public void deleteByMember(){
        Member member = Member.builder().mid(77L).build();
    ...
    public void updateByMember(){
        reviewRepository.updateByMember(51L);
